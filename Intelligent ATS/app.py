...
# Configure the generative Al model with the Google API key
...
def main():
    ...
    if submit_button:
        ...
        column_names = ["Candidate name", "Job Description Match", "Missing Keywords", "Candidate Summary", "Experience"]
        response_table = pd.DataFrame([response_dict], columns=column_names)
